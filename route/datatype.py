...
def CreateRoute():
    ...
    return_list.append((Loc.COLTER, Loc.WAPITI, 2))
    ...
    return_list.append((Loc.OCREAGB, Loc.OIL_FIELD, 4))
    return_list.append((Loc.OCREAGB, Loc.ANNESBURG, 4))
    return_list.append((Loc.OCREAGB, Loc.BUTCHER, 3))
    return_list.append((Loc.OCREAGB, Loc.EMERALD, 3))
    return_list.append((Loc.ANNESBURG, Loc.VAN_HORN, 2))
    return_list.append((Loc.ANNESBURG, Loc.BUTCHER, 2))
    return_list.append((Loc.PRONGHORN, Loc.WALLACE, 3))
    return_list.append((Loc.PRONGHORN, Loc.OWANJILA, 2))
    return_list.append((Loc.PRONGHORN, Loc.DAKOTA, 5))
    return_list.append((Loc.WALLACE, Loc.DAKOTA, 2))
    return_list.append((Loc.WALLACE, Loc.VALENTINE, 2))
    return_list.append((Loc.WALLACE, Loc.RIGGS, 2))
    ...
    return_list.append((Loc.VALENTINE, Loc.FLATNECK, 2))
    return_list.append((Loc.VALENTINE, Loc.BUCCHUS, 3))
    return_list.append((Loc.VALENTINE, Loc.HORSESHOE, 2))
    return_list.append((Loc.OIL_FIELD, Loc.EMERALD, 2))
    return_list.append((Loc.OIL_FIELD, Loc.HEARTLAND, 2))
    return_list.append((Loc.EMERALD, Loc.HEARTLAND, 2))
    ...
    return_list.append((Loc.EMERALD, Loc.ERIS_FIELD, 4))
    return_list.append((Loc.BUTCHER, Loc.VAN_HORN, 1))
    return_list.append((Loc.BUTCHER, Loc.LAGRAS, 5))
    ...
    return_list.append((Loc.STRAWBERRY, Loc.BEECHER, 2))
    return_list.append((Loc.STRAWBERRY, Loc.WALLACE, 2))
    return_list.append((Loc.STRAWBERRY, Loc.PRONGHORN, 2))
    return_list.append((Loc.RIGGS, Loc.FLATNECK, 2))
    return_list.append((Loc.RIGGS, Loc.BLACKWATER, 2))
    return_list.append((Loc.RIGGS, Loc.VALENTINE, 3))
    return_list.append((Loc.FLATNECK, Loc.HEARTLAND, 2))
    return_list.append((Loc.FLATNECK, Loc.RHODES, 5))
    return_list.append((Loc.FLATNECK, Loc.HORSESHOE, 1))
    return_list.append((Loc.HEARTLAND, Loc.RHODES, 4))
    return_list.append((Loc.HEARTLAND, Loc.HORSESHOE, 2))
    return_list.append((Loc.HEARTLAND, Loc.ERIS_FIELD, 2))
    return_list.append((Loc.LAGRAS, Loc.CALIGA, 2))
    return_list.append((Loc.LAGRAS, Loc.ST_DENIS, 3))
    return_list.append((Loc.LAGRAS, Loc.ERIS_FIELD, 3))
    ...
    return_list.append((Loc.RHODES, Loc.HORSESHOE, 4))
    return_list.append((Loc.RHODES, Loc.ERIS_FIELD, 3))
    return_list.append((Loc.RHODES, Loc.LAGRAS, 3))
